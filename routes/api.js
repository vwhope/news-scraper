...
app.get("/scrape", function(req, res) {
    ...
    axios.get("https://www.medicalnewstoday.com/categories/nutrition-diet/1").then(function(response) {
      ...
      function getData(i, element) {
        ...
        result.image = $(element).children("a").children("img").attr("src");
        result.date = $(element).children("a").children("span").children("span").text();
      
        // go to expanded article page to get summary text
        axios.get("https://www.medicalnewstoday.com" + result.link).then(function(response) {
